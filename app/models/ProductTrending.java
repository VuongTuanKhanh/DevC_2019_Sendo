...
@Entity
public class ProductTrending extends Model {
    @Id
    ...
    public ProductTrending(int product_id, String name, String image, String href, int price, int belong_cate_level1_id, int belong_cate_level2_id, int belong_cate_level3_id, int enable) {
